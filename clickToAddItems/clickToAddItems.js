...
document.getElementById("addResult").innerText = Number(num1) + Number(num1);
document.getElementById("subtractResult").innerText = Number(num1) - Number(num1);
document.getElementById("multiplyResult").innerText = Number(num1) * Number(num1);
document.getElementById("divideResult").innerText = Number(num1) / Number(num1);
return false;
}